  ...
  class Client
    ...
    module Stamp
      ...
      def create!(params = {})
        ...
        response.errors.empty? ? response.hash[:create_indicium_response] : response
      end
      ...
      def cancel!(params = {})
        ...
        response.errors.empty? ? response.hash[:cancel_indicium_response] : response
      end
      ...
      def track(stamps_transaction_id)
        ...
        response.errors.empty? ? response.hash[:track_shipment_response] : response
      end
